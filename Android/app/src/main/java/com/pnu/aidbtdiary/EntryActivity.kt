...
class EntryActivity : BaseActivity() {
    ...
    fun testInit2() {
        // 테스트용 초기화 메소드
        binding.etSituation.setText("오늘 시험을 망쳤어요.")
        binding.spEmotionType.setSelection(6) // "후회" 선택
        binding.sbEmotionIntensity.progress = 7 // 강한 강도
        binding.etThought.setText("왜 이런 일이 일어났을까요?")
        binding.etReaction.setText("혼자 집에 있었어요.")
    }
}